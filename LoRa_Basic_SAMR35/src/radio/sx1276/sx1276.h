/*!
 * @file    sx1276.h
 * @brief   HeaderFile of SX1276 driver implementation
 *
 * @details
 *
 * @code
...
#define RADIO_BANDWIDTH_EXTEND						1
...
#define FREQ_STEP                                   61.03515625		// = 32M / 2^19
#define USE_DOUBLE_CALC								0
...
/*!
 * \brief Gets bandwidth form number of bw
 *
