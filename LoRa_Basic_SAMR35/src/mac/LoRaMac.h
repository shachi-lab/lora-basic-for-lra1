...
#define LORA_MAC_DEVICE_TIME_REQ_ENABLE				1
...
typedef struct sMlmeConfirm
{
    ...
    uint8_t NbGateways;
    /*!
     * Device time which received the last DeviceTimeReq
     */
	struct{
		uint32_t TxDoneTime;
		uint32_t seconds;
...
#include "LoRaMacBackup.h"

#define	MAC_SAVE_ITEMS()	MAC_BACKUP_ITEM_SAVE()
